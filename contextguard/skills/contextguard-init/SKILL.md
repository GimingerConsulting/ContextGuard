---
name: contextguard-init
description: Initialize ContextGuard local project intelligence, managed guidance, SQLite index and savings tracking for the current project. Invoke explicitly with $contextguard-init.
---
